...
def epoch_wrapup(pl_module, phase):
    ...
    if pl_module.hparams.config['get_recall_metric'] and not pl_module.training:
        ...
        pl_module.logger.experiment.add_scalar(
            f"recalls/ir_r1", ir_r1, pl_module.global_step
        )
        pl_module.logger.experiment.add_scalar(
            f"recalls/ir_r5", ir_r5, pl_module.global_step
        )
        pl_module.logger.experiment.add_scalar(
            f"recalls/ir_r10", ir_r10, pl_module.global_step
        )
        pl_module.logger.experiment.add_scalar(
            f"recalls/tr_r1", tr_r1, pl_module.global_step
        )
        pl_module.logger.experiment.add_scalar(
            f"recalls/tr_r5", tr_r5, pl_module.global_step
        )
        pl_module.logger.experiment.add_scalar(
            f"recalls/tr_r10", tr_r10, pl_module.global_step
        )
